...
const getComics = (params) => `${COMICS_URL}/?api_key=${COMICS_API_KEY}&limit=${params.limit}&filter=name:${params.keyword},cover_date:${params.dateStart}|${params.dateEnd}&field_list=id,name,cover_date,image,volume&format=json`;
